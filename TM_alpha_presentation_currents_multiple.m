...
for rho = 1 : size(field_current_mat_output,1)
    for OMEGA_r = 1 : size(field_current_mat_output,2)
        ...
        field_current{rho,OMEGA_r,sce} = field_current_mat_output{rho,OMEGA_r,sce+12};
        ...
        a=linsolve((lineq_for_x),transpose([Iz]));
